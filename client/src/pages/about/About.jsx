    ...
    <>
      <div className="flex flex-col relative justify-center items-center">
        <article className='relative flex flex-col justify-center items-center my-10 px-20 py-18'>
          ...
          <p className='bg-blue-600 text-white backdrop-blur-lg p-8 max-width-40 border border-black rounded-lg w-3/4'>You and I both have a problem to solve.
          <br></br> 
          <br></br> 
        ...
        <article className='relative flex flex-col justify-center items-center my-10 px-20 py-18'>
          <h2 className='my-10 mx-10 text-[2.0rem] lg:text-[2.5rem]'>What is Koi?</h2>
          <p className='bg-blue-600 text-white backdrop-blur-lg p-8 max-width-40 border border-black rounded-lg w-3/4'>Koi exists to bring people back together to serve one another for the flourishing of our neighborhoods, communities, and towns. 
          <br />
          <br />
        ...
        <article className='relative flex flex-col justify-center items-center my-10 px-20 py-18'>
          <h2 className='my-10 mx-10 text-[2.0rem] lg:text-[2.5rem]'>Why Use Koi?</h2>
          <p className='bg-blue-600 text-white backdrop-blur-lg p-8 max-width-40 border border-black rounded-lg w-3/4'>You and I both want a social good - a sense that we are impacting our neighborhood. Often, it’s tough to figure out where to start. Who needs help? How could I support them? What skills could I use? 
          <br />
          <br />
        ...
        <article className='relative flex flex-col justify-center items-center my-10 px-20 py-18'>
          <h2 className='my-10 mx-10 text-[2.0rem] lg:text-[2.5rem]'>How Does Koi Work?</h2>
          <p className='bg-blue-600 text-white backdrop-blur-lg p-8 max-width-40 border border-black rounded-lg w-3/4'>Koi is a real-time platform that provides up-to-date service opportunities in your area. There are no long-term commitments, no lengthy sign-up, and no ambiguity - just you stepping into your neighborly call in an instant. 
          <br />
          <br />
